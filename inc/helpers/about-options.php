...
add_action('admin_init', function() {
    ...
    add_settings_field('my_portfolio_about_skills_languages', __('Skills: Languages', 'my-portfolio'), function() {
        ...
        echo '<input type="text" name="my_portfolio_about_skills_languages" value="' . esc_attr($value) . '" class="regular-text">';
    }, 'my_portfolio_theme_settings', 'my_portfolio_about_section');
    add_settings_field('my_portfolio_about_skills_other', __('Skills: Other', 'my-portfolio'), function() {
        ...
        echo '<input type="text" name="my_portfolio_about_skills_other" value="' . esc_attr($value) . '" class="regular-text">';
    }, 'my_portfolio_theme_settings', 'my_portfolio_about_section');
    add_settings_field('my_portfolio_about_skills_tools', __('Skills: Tools', 'my-portfolio'), function() {
        ...
        echo '<input type="text" name="my_portfolio_about_skills_tools" value="' . esc_attr($value) . '" class="regular-text">';
    }, 'my_portfolio_theme_settings', 'my_portfolio_about_section');
    add_settings_field('my_portfolio_about_skills_databases', __('Skills: Databases', 'my-portfolio'), function() {
        ...
        echo '<input type="text" name="my_portfolio_about_skills_databases" value="' . esc_attr($value) . '" class="regular-text">';
    }, 'my_portfolio_theme_settings', 'my_portfolio_about_section');
    add_settings_field('my_portfolio_about_skills_frameworks', __('Skills: Frameworks', 'my-portfolio'), function() {
        $value = get_option('my_portfolio_about_skills_frameworks', 'React Vue\nDisnake Discord.js\nFlask Express.js');
        echo '<input type="text" name="my_portfolio_about_skills_frameworks" value="' . esc_attr($value) . '" class="regular-text">';
    }, 'my_portfolio_theme_settings', 'my_portfolio_about_section');
